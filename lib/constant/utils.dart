...
Widget CustomButton(text, fun) => Container(
      constraints: const BoxConstraints(maxWidth: 220.0, minHeight: 40.0),
      margin: const EdgeInsets.all(10),
      child: ElevatedButton(
        onPressed: fun,
        style: ElevatedButton.styleFrom(
          primary: Color.fromARGB(255, 49, 175, 143),
        ),
        child: Padding(
      ...
      child: HoverCrossFadeWidget(
        firstChild: Container(
          ...
          decoration: BoxDecoration(
              color: Colors.white,
              border: Border.all(
                  color: Color.fromARGB(255, 49, 175, 143).withOpacity(0.15),
                  width: 10),
        ...
        secondChild: Container(
          ...
          decoration: BoxDecoration(
              color: Colors.white,
              border: Border.all(
                  color: Color.fromARGB(255, 49, 175, 143).withOpacity(0.4),
                  width: 10),
...
Widget CustomTextFiled(text, label) => Column(
