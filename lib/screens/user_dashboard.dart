...
class _UserDashBoardState extends State<UserDashBoard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 49, 175, 143),
        leading: isDesktop
            ? Container()
            : GestureDetector(
                child: const Padding(
      ...
      drawer: drawer2(),
      drawerScrimColor: Color.fromARGB(255, 49, 175, 143),
      body: Row(
        children: [
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Container(
          ...
          decoration: const BoxDecoration(
            border: Border(
                bottom: BorderSide(
                    color: Color.fromARGB(159, 158, 158, 158), width: 1)),
          ),
          child: Row(
            children: [
              Expanded(
        ...
        child: Column(
          ...
          children: [
            ...
            userInfo[8]
                ...
                : const Text(
                    'User not verified by Land Inspector',
                    style: TextStyle(
    ...
    return Container(
      decoration: const BoxDecoration(
        boxShadow: [
          BoxShadow(
              blurRadius: 10,
              color: Color.fromARGB(255, 46, 177, 144),
              spreadRadius: 2),
        ],
        color: Color.fromARGB(255, 49, 175, 143),
      ),
