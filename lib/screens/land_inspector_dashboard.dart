  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 49, 175, 143),
        leading: isDesktop
            ? Container()
            : GestureDetector(
                child: const Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                    ...
                    flex: 3),
                Expanded(
                    child: Center(child: Text(data[3].toString())), flex: 2),
                Expanded(
                    child: Center(child: Text(data[5].toString())), flex: 2),
                Expanded(
                    child: Center(child: Text(data[6].toString())), flex: 2),
                Expanded(
                    child: Center(
                        child: TextButton(
                      onPressed: () {
                      ...
                      child: const Text(
                        'View Document',
                        style:
                            TextStyle(color: Color.fromARGB(255, 49, 175, 143)),
                      ),
                    )),
                    flex: 2),
                Expanded(
